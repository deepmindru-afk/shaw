...
struct TTSVoice: Identifiable, Codable, Equatable {
    ...
    static let openaiRealtimeVoices: [TTSVoice] = [
        TTSVoice(id: "alloy", name: "Alloy", description: "Unavailable – OpenAI Realtime mode is disabled", provider: .openaiRealtime, requiresPro: true),
        TTSVoice(id: "echo", name: "Echo", description: "Unavailable – OpenAI Realtime mode is disabled", provider: .openaiRealtime, requiresPro: true),
        TTSVoice(id: "fable", name: "Fable", description: "Unavailable – OpenAI Realtime mode is disabled", provider: .openaiRealtime, requiresPro: true),
        TTSVoice(id: "onyx", name: "Onyx", description: "Unavailable – OpenAI Realtime mode is disabled", provider: .openaiRealtime, requiresPro: true),
        TTSVoice(id: "nova", name: "Nova", description: "Unavailable – OpenAI Realtime mode is disabled", provider: .openaiRealtime, requiresPro: true),
        TTSVoice(id: "shimmer", name: "Shimmer", description: "Unavailable – OpenAI Realtime mode is disabled", provider: .openaiRealtime, requiresPro: true)
    ]
